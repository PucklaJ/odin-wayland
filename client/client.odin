...
shell_surface_resize_enum :: enum u32 {SHELL_SURFACE_RESIZE_NONE = 0, SHELL_SURFACE_RESIZE_TOP = 1, SHELL_SURFACE_RESIZE_BOTTOM = 2, SHELL_SURFACE_RESIZE_LEFT = 4, SHELL_SURFACE_RESIZE_TOP_LEFT = 5, SHELL_SURFACE_RESIZE_BOTTOM_LEFT = 6, SHELL_SURFACE_RESIZE_RIGHT = 8, SHELL_SURFACE_RESIZE_TOP_RIGHT = 9, SHELL_SURFACE_RESIZE_BOTTOM_RIGHT = 10, }
